...
vsf_err_t vsf_eth_send_request(vsf_eth_t *eth_ptr, vsf_eth_send_buf_t *buf_ptr)
{
    VSF_HAL_ASSERT(eth_ptr != NULL);
    VSF_HAL_ASSERT(eth_ptr->op != NULL);
...
vsf_err_t vsf_eth_recv_request(vsf_eth_t *eth_ptr, vsf_eth_recv_buf_t *buf_ptr)
{
    VSF_HAL_ASSERT(eth_ptr != NULL);
    VSF_HAL_ASSERT(eth_ptr->op != NULL);
...
vsf_err_t vsf_eth_sg_send_request(vsf_eth_t *eth_ptr, vsf_eth_sg_send_buf_t *buf_ptr, uint32_t sg_count)
{
    VSF_HAL_ASSERT(eth_ptr != NULL);
    VSF_HAL_ASSERT(eth_ptr->op != NULL);
    VSF_HAL_ASSERT(eth_ptr->op->sg_send_request != NULL);

    return eth_ptr->op->sg_send_request(eth_ptr, buf_ptr, sg_count);
}

vsf_err_t vsf_eth_sg_recv_request(vsf_eth_t *eth_ptr, vsf_eth_sg_recv_buf_t *buf_ptr, uint32_t sg_count)
{
    VSF_HAL_ASSERT(eth_ptr != NULL);
    VSF_HAL_ASSERT(eth_ptr->op != NULL);
    VSF_HAL_ASSERT(eth_ptr->op->sg_recv_request != NULL);

    return eth_ptr->op->sg_recv_request(eth_ptr, buf_ptr, sg_count);
}
