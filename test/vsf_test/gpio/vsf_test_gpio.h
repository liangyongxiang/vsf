...
#if VSF_TEST_GPIO_OUTPUT_INPUT_ENABLE == ENABLED
void vsf_test_gpio_output_input_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif
...
#if VSF_TEST_GPIO_ATOMIC_ENABLE == ENABLED
void vsf_test_gpio_atomic_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif
...
#if VSF_TEST_GPIO_OPEN_DRAIN_ENABLE == ENABLED
void vsf_test_gpio_open_drain_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif

#if VSF_TEST_GPIO_TOGGLE_FREQ_ENABLE == ENABLED
void vsf_test_gpio_toggle_freq_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif

#if VSF_TEST_GPIO_WRITE_THROUGHPUT_ENABLE == ENABLED
void vsf_test_gpio_write_throughput_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif

#if VSF_TEST_GPIO_TOGGLE_STRESS_ENABLE == ENABLED
void vsf_test_gpio_toggle_stress_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif
...
#if VSF_TEST_GPIO_ANALOG_MODE_ENABLE == ENABLED
void vsf_test_gpio_analog_mode_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture);
#endif
