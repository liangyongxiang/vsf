...
//! \brief GPIO scenario shared runtime state
typedef struct vsf_test_gpio_scenario_t {
    vsf_gpio_t *gpio_instance;
} vsf_test_gpio_scenario_t;
...
#if VSF_TEST_GPIO_TOGGLE_ENABLE == ENABLED
void vsf_test_gpio_toggle_add_cases(vsf_gpio_t *gpio_instance);
...
#if VSF_TEST_GPIO_OPEN_DRAIN_ENABLE == ENABLED
void vsf_test_gpio_open_drain_add_cases(vsf_gpio_t *gpio_instance);
