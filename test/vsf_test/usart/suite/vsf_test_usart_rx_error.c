...
void vsf_test_usart_rx_parity_error_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture)
{
    ...
    if (p->expect_pass) {
        ...
        vsf_usart_irq_enable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_PARITY_ERR);
        ...
        vsf_usart_irq_disable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_PARITY_ERR);
...
void vsf_test_usart_rx_frame_error_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture)
{
    ...
    if (p->expect_pass) {
        ...
        vsf_usart_irq_enable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_FRAME_ERR);
        ...
        vsf_usart_irq_disable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_FRAME_ERR);
...
void vsf_test_usart_rx_break_error_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture)
{
    ...
    if (p->expect_pass) {
        ...
        vsf_usart_irq_enable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_BREAK_ERR);
        ...
        vsf_usart_irq_disable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_BREAK_ERR);
...
void vsf_test_usart_rx_overflow_error_run(const vsf_test_suite_t *suite, const vsf_test_case_t *tc, const void *fixture)
{
    ...
    if (p->expect_pass) {
        ...
        vsf_usart_irq_enable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_RX_OVERFLOW_ERR);
        ...
        vsf_usart_irq_disable((vsf_usart_t *)fixture, VSF_USART_IRQ_MASK_RX_OVERFLOW_ERR);
