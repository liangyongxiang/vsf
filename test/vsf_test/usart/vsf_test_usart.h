...
void vsf_test_usart_rx_baud_run(vsf_test_case_t *tc);
#endif

#if VSF_TEST_USART_RX_MODE_ENABLE == ENABLED
void vsf_test_usart_rx_mode_run(vsf_test_case_t *tc);
#endif

#if VSF_TEST_USART_RX_IRQ_ENABLE == ENABLED
void vsf_test_usart_rx_irq_run(vsf_test_case_t *tc);
#endif
...
#if VSF_TEST_USART_TX_FIFO_IRQ_ENABLE == ENABLED
void vsf_test_usart_tx_fifo_irq_run(vsf_test_case_t *tc);
#endif
...
#if VSF_TEST_USART_REQUEST_TX_IRQ_ENABLE == ENABLED
void vsf_test_usart_request_tx_irq_run(vsf_test_case_t *tc);
#endif

#if VSF_TEST_USART_REQUEST_RX_IRQ_ENABLE == ENABLED
void vsf_test_usart_request_rx_irq_run(vsf_test_case_t *tc);
#endif
...
#if VSF_TEST_USART_RX_FIFO_THRESHOLD_ENABLE == ENABLED
void vsf_test_usart_rx_fifo_threshold_run(vsf_test_case_t *tc);
#endif
