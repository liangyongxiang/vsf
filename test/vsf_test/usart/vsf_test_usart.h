...
VSF_TEST_DECLARE_TABLE(vsf_test_usart_baud_table_t, vsf_test_usart_baud_suite_t, vsf_test_usart_baud_case_t, VSF_TEST_USART_TX_BAUD_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_mode_table_t, vsf_test_usart_mode_suite_t, vsf_test_usart_mode_case_t, VSF_TEST_USART_TX_MODE_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_data_table_t, vsf_test_usart_rx_data_suite_t, vsf_test_usart_rx_data_case_t, VSF_TEST_USART_RX_DATA_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_baud_table_t, vsf_test_usart_rx_baud_suite_t, vsf_test_usart_rx_baud_case_t, VSF_TEST_USART_RX_BAUD_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_mode_table_t, vsf_test_usart_rx_mode_suite_t, vsf_test_usart_rx_mode_case_t, VSF_TEST_USART_RX_MODE_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_irq_table_t, vsf_test_usart_rx_irq_suite_t, vsf_test_usart_rx_irq_case_t, VSF_TEST_USART_RX_IRQ_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_timeout_table_t, vsf_test_usart_rx_timeout_suite_t, vsf_test_usart_rx_timeout_case_t, VSF_TEST_USART_RX_TIMEOUT_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_parity_error_table_t, vsf_test_usart_rx_parity_error_suite_t, vsf_test_usart_rx_parity_error_case_t, VSF_TEST_USART_RX_PARITY_ERROR_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_frame_error_table_t, vsf_test_usart_rx_frame_error_suite_t, vsf_test_usart_rx_frame_error_case_t, VSF_TEST_USART_RX_FRAME_ERROR_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_break_error_table_t, vsf_test_usart_rx_break_error_suite_t, vsf_test_usart_rx_break_error_case_t, VSF_TEST_USART_RX_BREAK_ERROR_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_overflow_error_table_t, vsf_test_usart_rx_overflow_error_suite_t, vsf_test_usart_rx_overflow_error_case_t, VSF_TEST_USART_RX_OVERFLOW_ERROR_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_break_signal_table_t, vsf_test_usart_break_signal_suite_t, vsf_test_usart_break_signal_case_t, VSF_TEST_USART_BREAK_SIGNAL_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_hw_flow_control_table_t, vsf_test_usart_hw_flow_control_suite_t, vsf_test_usart_hw_flow_control_case_t, VSF_TEST_USART_HW_FLOW_CONTROL_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_tx_fifo_irq_table_t, vsf_test_usart_tx_fifo_irq_suite_t, vsf_test_usart_tx_fifo_irq_case_t, VSF_TEST_USART_TX_FIFO_IRQ_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_fifo_irq_table_t, vsf_test_usart_rx_fifo_irq_suite_t, vsf_test_usart_rx_fifo_irq_case_t, VSF_TEST_USART_RX_FIFO_IRQ_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_request_tx_irq_table_t, vsf_test_usart_request_tx_irq_suite_t, vsf_test_usart_request_tx_irq_case_t, VSF_TEST_USART_REQUEST_TX_IRQ_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_request_rx_irq_table_t, vsf_test_usart_request_rx_irq_suite_t, vsf_test_usart_request_rx_irq_case_t, VSF_TEST_USART_REQUEST_RX_IRQ_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_request_cancel_table_t, vsf_test_usart_request_cancel_suite_t, vsf_test_usart_request_cancel_case_t, VSF_TEST_USART_REQUEST_CANCEL_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_bulk_irq_table_t, vsf_test_usart_rx_bulk_irq_suite_t, vsf_test_usart_rx_bulk_irq_case_t, VSF_TEST_USART_RX_BULK_IRQ_CASE_COUNT);
VSF_TEST_DECLARE_TABLE(vsf_test_usart_rx_fifo_threshold_table_t, vsf_test_usart_rx_fifo_threshold_suite_t, vsf_test_usart_rx_fifo_threshold_case_t, VSF_TEST_USART_RX_FIFO_THRESHOLD_CASE_COUNT);

/*============================ STATIC INIT MACROS ============================*/

#if VSF_TEST_USART_TX_BAUD_ENABLE == ENABLED
#define VSF_TEST_USART_BAUD_STATIC(suite_var, name_str) \
    static vsf_test_usart_baud_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
        ...
        .data  = { VSF_TEST_USART_TX_BAUD_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_TX_BAUD_CASES(suite_var.data, vsf_test_usart_baud_run, false) }, \
    }
#endif

#if VSF_TEST_USART_TX_MODE_ENABLE == ENABLED
#define VSF_TEST_USART_MODE_STATIC(suite_var, name_str) \
    static vsf_test_usart_mode_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_TX_MODE_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_TX_MODE_CASES(suite_var.data, vsf_test_usart_mode_run, false) }, \
    }
#endif

#if VSF_TEST_USART_RX_DATA_ENABLE == ENABLED
#define VSF_TEST_USART_RX_DATA_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_data_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_DATA_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_DATA_CASES(suite_var.data, vsf_test_usart_rx_data_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_BAUD_ENABLE == ENABLED
#define VSF_TEST_USART_RX_BAUD_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_baud_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_BAUD_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_BAUD_CASES(suite_var.data, vsf_test_usart_rx_baud_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_MODE_ENABLE == ENABLED
#define VSF_TEST_USART_RX_MODE_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_mode_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_MODE_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_MODE_CASES(suite_var.data, vsf_test_usart_rx_mode_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_IRQ_ENABLE == ENABLED
#define VSF_TEST_USART_RX_IRQ_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_irq_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_IRQ_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_IRQ_CASES(suite_var.data, vsf_test_usart_rx_irq_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_TIMEOUT_ENABLE == ENABLED
#define VSF_TEST_USART_RX_TIMEOUT_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_timeout_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_TIMEOUT_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_TIMEOUT_CASES(suite_var.data, vsf_test_usart_rx_timeout_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_PARITY_ERROR_ENABLE == ENABLED
#define VSF_TEST_USART_RX_PARITY_ERROR_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_parity_error_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_PARITY_ERROR_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_PARITY_ERROR_CASES(suite_var.data, vsf_test_usart_rx_parity_error_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_FRAME_ERROR_ENABLE == ENABLED
#define VSF_TEST_USART_RX_FRAME_ERROR_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_frame_error_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_FRAME_ERROR_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_FRAME_ERROR_CASES(suite_var.data, vsf_test_usart_rx_frame_error_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_BREAK_ERROR_ENABLE == ENABLED
#define VSF_TEST_USART_RX_BREAK_ERROR_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_break_error_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_BREAK_ERROR_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_BREAK_ERROR_CASES(suite_var.data, vsf_test_usart_rx_break_error_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_OVERFLOW_ERROR_ENABLE == ENABLED
#define VSF_TEST_USART_RX_OVERFLOW_ERROR_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_overflow_error_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_OVERFLOW_ERROR_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_OVERFLOW_ERROR_CASES(suite_var.data, vsf_test_usart_rx_overflow_error_run, true) }, \
    }
#endif

#if VSF_TEST_USART_BREAK_SIGNAL_ENABLE == ENABLED
#define VSF_TEST_USART_BREAK_SIGNAL_STATIC(suite_var, name_str) \
    static vsf_test_usart_break_signal_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_BREAK_SIGNAL_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_BREAK_SIGNAL_CASES(suite_var.data, vsf_test_usart_break_signal_run, false) }, \
    }
#endif

#if VSF_TEST_USART_HW_FLOW_CONTROL_ENABLE == ENABLED
#define VSF_TEST_USART_HW_FLOW_CONTROL_STATIC(suite_var, name_str) \
    static vsf_test_usart_hw_flow_control_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_HW_FLOW_CONTROL_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_HW_FLOW_CONTROL_CASES(suite_var.data, vsf_test_usart_hw_flow_control_run, false) }, \
    }
#endif

#if VSF_TEST_USART_TX_FIFO_IRQ_ENABLE == ENABLED
#define VSF_TEST_USART_TX_FIFO_IRQ_STATIC(suite_var, name_str) \
    static vsf_test_usart_tx_fifo_irq_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_TX_FIFO_IRQ_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_TX_FIFO_IRQ_CASES(suite_var.data, vsf_test_usart_tx_fifo_irq_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_FIFO_IRQ_ENABLE == ENABLED
#define VSF_TEST_USART_RX_FIFO_IRQ_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_fifo_irq_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_FIFO_IRQ_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_FIFO_IRQ_CASES(suite_var.data, vsf_test_usart_rx_fifo_irq_run, true) }, \
    }
#endif

#if VSF_TEST_USART_REQUEST_TX_IRQ_ENABLE == ENABLED
#define VSF_TEST_USART_REQUEST_TX_IRQ_STATIC(suite_var, name_str) \
    static vsf_test_usart_request_tx_irq_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_REQUEST_TX_IRQ_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_REQUEST_TX_IRQ_CASES(suite_var.data, vsf_test_usart_request_tx_irq_run, false) }, \
    }
#endif

#if VSF_TEST_USART_REQUEST_RX_IRQ_ENABLE == ENABLED
#define VSF_TEST_USART_REQUEST_RX_IRQ_STATIC(suite_var, name_str) \
    static vsf_test_usart_request_rx_irq_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_REQUEST_RX_IRQ_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_REQUEST_RX_IRQ_CASES(suite_var.data, vsf_test_usart_request_rx_irq_run, true) }, \
    }
#endif

#if VSF_TEST_USART_REQUEST_CANCEL_ENABLE == ENABLED
#define VSF_TEST_USART_REQUEST_CANCEL_STATIC(suite_var, name_str) \
    static vsf_test_usart_request_cancel_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_REQUEST_CANCEL_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_REQUEST_CANCEL_CASES(suite_var.data, vsf_test_usart_request_cancel_run, false) }, \
    }
#endif

#if VSF_TEST_USART_RX_BULK_IRQ_ENABLE == ENABLED
#define VSF_TEST_USART_RX_BULK_IRQ_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_bulk_irq_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_BULK_IRQ_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_BULK_IRQ_CASES(suite_var.data, vsf_test_usart_rx_bulk_irq_run, true) }, \
    }
#endif

#if VSF_TEST_USART_RX_FIFO_THRESHOLD_ENABLE == ENABLED
#define VSF_TEST_USART_RX_FIFO_THRESHOLD_STATIC(suite_var, name_str) \
    static vsf_test_usart_rx_fifo_threshold_table_t suite_var = { \
        .suite = { \
            .name       = name_str, \
            .cases      = suite_var.cases, \
        ...
        .data  = { VSF_TEST_USART_RX_FIFO_THRESHOLD_CASE_DATA(&suite_var.suite) }, \
        .cases = { VSF_TEST_USART_RX_FIFO_THRESHOLD_CASES(suite_var.data, vsf_test_usart_rx_fifo_threshold_run, true) }, \
    }
#endif
